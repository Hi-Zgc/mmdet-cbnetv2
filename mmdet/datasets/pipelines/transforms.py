...
class Mosaic:
    ...
    def _mosaic_transform(self, results):
        ...
        for i, loc in enumerate(loc_strs):
            ...
            # resize 报错 error: (-215:Assertion failed) func != 0 in function 'cv::hal::resize'
            img_i = np.array(img_i, dtype='uint8')
...
class CopyPaste:
    ...
    def get_gt_masks(self, results):
        """获取最初的gt_masks或基于bboxes生成的gt_mask
            如果gt_ mass不包含在结果中，
            它将基于gt_bboxes生成。
        Args:
            results (dict): Result dict.
        Returns:
            BitmapMasks: gt_masks，最初或基于bboxes生成
        """
